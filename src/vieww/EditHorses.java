 ...
 * @author kiYo
 */
public class EditHorses extends javax.swing.JFrame {

    /**
     * Creates new form EditHorses
     */
    public EditHorses() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditHorses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditHorses().setVisible(true);
            }
        });
    }
