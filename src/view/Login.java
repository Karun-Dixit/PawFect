...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(808, 429));
        setResizable(false);
        ...
        userNameText.setBackground(new java.awt.Color(230, 230, 230));

        passwordText.setBackground(new java.awt.Color(230, 230, 230));
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        ...
        if(username.isEmpty() || pass.isEmpty()){
            JOptionPane.showMessageDialog(this,"Username/Password shouldnot be empty!","Error",JOptionPane.ERROR_MESSAGE);
        }else{
            try {
    ...
    private void userLogin(String username, String pass) throws SQLException {
        Connection dbconn = (Connection) DbConnection.connectDB();
        if(dbconn != null){
        try{
            PreparedStatement st = (PreparedStatement)
                    dbconn.prepareStatement("Select * from Users WHERE uName=? AND pass=?");
