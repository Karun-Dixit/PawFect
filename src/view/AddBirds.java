...
import controller.AddBirdsController;
import javax.swing.JOptionPane;
import model.AddBirdsModel;
import static model.AddBirdsModel.*;
 ...
 * @author Karun Dixit
 */
public class AddBirds extends javax.swing.JFrame {

    /**
     * Creates new form AddBirds
     */
    public AddBirds() {
        initComponents();
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        AddBirdsController scontrol = new AddBirdsController(getuser(),this);
        scontrol.addBirds();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBirds.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    // End of variables declaration//GEN-END:variables
     public AddBirdsModel getuser(){
    AddBirdsModel Birdsss = new AddBirdsModel(
        Name.getText(),
