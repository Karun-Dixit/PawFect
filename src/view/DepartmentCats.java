 ...
 * @author Karun Dixit
 */
public class DepartmentCats extends javax.swing.JFrame {

    /**
     * Creates new form DepartmentCats
     */
    public DepartmentCats() {
        initComponents();
        CatsController rcontrol=new CatsController(getValueTable(),this);
        if(!rcontrol.allCats()){
            JOptionPane.showMessageDialog(null, "Error");
        }
        }
    public CatsModel getValueTable(){
        DefaultTableModel tableName=(DefaultTableModel) catsTable.getModel();
        CatsModel obj=new CatsModel(tableName);
        return obj;
        }
    ...
    private void initComponents() {
        ...
        catsTable = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setPreferredSize(new java.awt.Dimension(781, 349));
        ...
        catsTable.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        catsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        catsTable.setGridColor(new java.awt.Color(51, 51, 51));
        catsTable.setShowGrid(true);
        jScrollPane1.setViewportView(catsTable);
    ...
    setVisible(true);
    EditCats s= new EditCats();
    s.setTitle("Edit Cats");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepartmentCats.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepartmentCats().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable catsTable;
