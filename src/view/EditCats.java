 ...
 */
package view;
import controller.EditCatsController;
import javax.swing.JOptionPane;
import model.EditCatsModel;
import static model.EditCatsModel.*;
/**
 *
 * @author Karun Dixit
 */
public class EditCats extends javax.swing.JFrame {

    /**
     * Creates new form EditCats
     */
    public EditCats() {
        initComponents();
    }
    ...
    private void bthUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bthUpdateActionPerformed
        ...
        EditCatsController econtrol = new EditCatsController(getuser(),this);
        if(econtrol.uptCats()){
        dID.setText("");
        txtName.setText("");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
        EditCatsController econtrol = new EditCatsController(getuser(),this);
        if(econtrol.searchCats()){
        txtName.setText(getNameC());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditCats.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public EditCatsModel getuser(){
        EditCatsModel catsss= new EditCatsModel(
            dID.getText(),
            txtName.getText(),
